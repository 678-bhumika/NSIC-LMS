    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt30 pt-20 text-left'>
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from cyan-100/70'></div>
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-gray-500'> {courseData.enrolledLearners.length} {courseData.enrolledLearners.length > 1 ? 'learners' : 'learner'} </p>
        </div>
            <p>Course By: <span className='text-blue-600 underline'>{courseData.instructor.name}</span></p>
                          ...
                          <li key={i} className='flex items-start gap-2 py-1'>
                            ...
                            <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                              ...
                              <div className='flex gap-2'>
                                ...
                                })} className='text-blue-500 coursor-pointer'>Preview</p>}
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w=[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <p className='text-red-500'><span className='foont-medium'>5 days</span>left at this price</p>
            </div> 
            <div className='flex gap-3 items-center pt-2'>
              <p className='text-gray-800 md:text-4xl text-2xl font-semibold'>{currency} {(courseData.coursePrice - courseData.discount * courseData.coursePrice/100).toFixed(2)} </p>
              <p className='md:text-lg tetx-gray-500 line-through'> {currency}{courseData.coursePrice} </p>
            ...
            <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>  {isAlreadyEnrolled ? 'Alreday Enrolled' : 'Enroll Now'} </button>
